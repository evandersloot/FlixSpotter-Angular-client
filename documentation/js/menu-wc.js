...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">flix-spotter-angular-client documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-35b4ff9e63663b956098fbed6acb217d"' : 'data-target="#xs-components-links-module-AppModule-35b4ff9e63663b956098fbed6acb217d"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-35b4ff9e63663b956098fbed6acb217d"' :
                                            'id="xs-components-links-module-AppModule-35b4ff9e63663b956098fbed6acb217d"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/MovieDirectorComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >MovieDirectorComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/MovieGenreComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >MovieGenreComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/MovieViewComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >MovieViewComponent</a>
                                            </li>
                                            <li class="link">
